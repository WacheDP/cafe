...
if (isset($_POST['btn'])) {
    ...
    if (!empty($_POST['costo'])) {
        $sql = $database->prepare('UPDATE almacen_activos SET costo_unidad = ? WHERE id = ?');
    ...
    if (!empty($_POST['almacen'])) {
        $sql = $database->prepare('UPDATE almacen_activos SET almacen = ? WHERE id = ?');
    ...
    if (!empty($_POST['estado'])) {
        $sql = $database->prepare('UPDATE almacen_activos SET estado = ? WHERE id = ?');
